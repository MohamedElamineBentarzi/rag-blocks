...
decisions and rationale, contract semantics, specs for not-yet-coded
components, conventions, testing rules, roadmap). Treat AGENTS.md as
authoritative over your defaults.
